...
public class Patrimonio {
	...
	public Patrimonio(){
		//Fun��o usada para criar patrimonios de teste
	}
	...
	public Patrimonio(Integer id){
		...
		System.out.print("ID Bloco para aloca��o:");
		Main.salaController.listarPorBloco(Main.scan.nextInt());
		
		System.out.print("ID Sala para aloca��o:");
		...
		if(answer == 1){
			...
			Main.scan.nextLine();
			System.out.print("Data da proxima manuten��o(dd/MM/aaaa): ");
